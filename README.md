...
I am an applied machine learning scientist. I have a profound passion for data-driven problem-solving and love to build end-to-end Machine Learning pipelines to solve real-life problems.
...
* Geospatial Analysis.
* Snow Science.
* Remote Sensing (lidar and InSAR).
* Natural Language Processing (e.g., Agents, LLMs and Conversational AI systems).
